...
<div class="bmm-form-editor">
	...
	<table class="form-table">
		<tr>
			<th><label for="bmm_form_max_installments"><?php esc_html_e( 'Max Installments (Tashlumim)', 'bmm-registration' ); ?></label></th>
			<td>
				<input type="number" id="bmm_form_max_installments" name="bmm_form_max_installments" value="<?php echo esc_attr( $m( 'max_installments', 12 ) ); ?>" min="1" max="36" class="small-text" />
				<p class="description"><?php esc_html_e( 'Largest number of monthly payments a customer may split the total into. The customer chooses to pay in full (1 payment) or in Tashlumim (2 up to this number). Set to 1 to allow full payment only (no installments).', 'bmm-registration' ); ?></p>
			</td>
		</tr>
	</table>
