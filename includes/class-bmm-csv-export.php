...
class BMM_CSV_Export {
	...
	private static function get_headers(): array {
		return [
			...
			"Men's Seats - RH", "Women's Seats - RH", "Men's Seats - YK", "Women's Seats - YK",
	...
	private static function get_row( \WP_Post $post ): array {
		...
		return [
			...
			// Peak seats per holiday (max across that holiday's davenings)
			BMM_Pricing::seats_for_holiday( $seats_men, 'rh' ),
			BMM_Pricing::seats_for_holiday( $seats_women, 'rh' ),
			BMM_Pricing::seats_for_holiday( $seats_men, 'yk' ),
			BMM_Pricing::seats_for_holiday( $seats_women, 'yk' ),
